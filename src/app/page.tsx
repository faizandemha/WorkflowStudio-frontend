...
export default async function DashboardPage() {
  ...
  return (
    <DashboardShell>
      <header className="flex flex-col gap-3 border-b border-border bg-surface px-4 py-4 shadow-[0_1px_0_0_rgba(16,27,61,0.02),0_2px_8px_0_rgba(16,27,61,0.03)] sm:flex-row sm:items-center sm:justify-between sm:px-8 sm:py-6">
        <div>
